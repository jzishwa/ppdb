...
<head>
    ...
    <!-- General CSS Files -->
    <link rel="stylesheet" href="<?= BASEURL; ?>/public/modules/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?= BASEURL; ?>/public/modules/fontawesome/css/all.min.css">

    <!-- CSS Libraries -->
    <link rel="stylesheet" href="<?= BASEURL; ?>/public/modules/jqvmap/dist/jqvmap.min.css">
    <link rel="stylesheet" href="<?= BASEURL; ?>/public/modules/weather-icon/css/weather-icons.min.css">
    <link rel="stylesheet" href="<?= BASEURL; ?>/public/modules/weather-icon/css/weather-icons-wind.min.css">
    <link rel="stylesheet" href="<?= BASEURL; ?>/public/modules/summernote/summernote-bs4.css">

    <!-- Template CSS -->
    <link rel="stylesheet" href="<?= BASEURL; ?>/public/css/style.css">
    <link rel="stylesheet" href="<?= BASEURL; ?>/public/css/components.css">
    <!-- Start GA -->
...
<body>
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <form class="form-inline mr-auto">
                    ...
                    <div class="search-element">
                        ...
                        <div class="search-result">
                            ...
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30" src="<?= BASEURL; ?>/public/img/products/product-3-50.png" alt="product">
                                    oPhone S9 Limited Edition
                                </a>
                            </div>
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30" src="<?= BASEURL; ?>/public/img/products/product-2-50.png" alt="product">
                                    Drone X2 New Gen-7
                                </a>
                            </div>
                            <div class="search-item">
                                <a href="#">
                                    <img class="mr-3 rounded" width="30" src="<?= BASEURL; ?>/public/img/products/product-1-50.png" alt="product">
                                    Headphone Blitz
                                </a>
                            </div>
                            <div class="search-header">
                ...
                <ul class="navbar-nav navbar-right">
                            ...
                            <div class="dropdown-list-content dropdown-list-message">
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image" src="<?= BASEURL; ?>/public/img/avatar/avatar-1.png" class="rounded-circle">
                                ...
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image" src="<?= BASEURL; ?>/public/img/avatar/avatar-2.png" class="rounded-circle">
                                    </div>
                                    <div class="dropdown-item-desc">
                                        <b>Dedik Sugiharto</b>
                                ...
                                <a href="#" class="dropdown-item dropdown-item-unread">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image" src="<?= BASEURL; ?>/public/img/avatar/avatar-3.png" class="rounded-circle">
                                        <div class="is-online"></div>
                                    </div>
                                    <div class="dropdown-item-desc">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image" src="<?= BASEURL; ?>/public/img/avatar/avatar-4.png" class="rounded-circle">
                                    </div>
                                    <div class="dropdown-item-desc">
                                ...
                                <a href="#" class="dropdown-item">
                                    <div class="dropdown-item-avatar">
                                        <img alt="image" src="<?= BASEURL; ?>/public/img/avatar/avatar-5.png" class="rounded-circle">
                                    </div>
                                    <div class="dropdown-item-desc">
                                        <b>Alfa Zulkarnain</b>
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <img alt="image" src="<?= BASEURL; ?>/public/img/avatar/avatar-1.png" class="rounded-circle mr-1">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="list-unstyled list-unstyled-border">
                                        <li class="media">
                                            <img class="mr-3 rounded-circle" width="50" src="<?= BASEURL; ?>/public/img/avatar/avatar-1.png" alt="avatar">
                                        ...
                                        <li class="media">
                                            <img class="mr-3 rounded-circle" width="50" src="<?= BASEURL; ?>/public/img/avatar/avatar-2.png" alt="avatar">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <img class="mr-3 rounded-circle" width="50" src="<?= BASEURL; ?>/public/img/avatar/avatar-3.png" alt="avatar">
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            <img class="mr-3 rounded-circle" width="50" src="<?= BASEURL; ?>/public/img/avatar/avatar-4.png" alt="avatar">
                                            <div class="media-body">
                                    ...
                                    <div class="row pb-2">
                                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                            <div class="avatar-item mb-0">
                                                <img alt="image" src="<?= BASEURL; ?>/public/img/avatar/avatar-5.png" class="img-fluid" data-toggle="tooltip" title="Alfa Zulkarnain">
                                                <div class="avatar-badge" title="Editor" data-toggle="tooltip"><i class="fas fa-wrench"></i></div>
                                            </div>
                                        </div>
                                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                            <div class="avatar-item mb-0">
                                                <img alt="image" src="<?= BASEURL; ?>/public/img/avatar/avatar-4.png" class="img-fluid" data-toggle="tooltip" title="Egi Ferdian">
                                                <div class="avatar-badge" title="Admin" data-toggle="tooltip"><i class="fas fa-cog"></i></div>
                                            </div>
                                        </div>
                                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                            <div class="avatar-item mb-0">
                                                <img alt="image" src="<?= BASEURL; ?>/public/img/avatar/avatar-1.png" class="img-fluid" data-toggle="tooltip" title="Jaka Ramadhan">
                                                <div class="avatar-badge" title="Author" data-toggle="tooltip"><i class="fas fa-pencil-alt"></i></div>
                                            </div>
                                        </div>
                                        <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                            <div class="avatar-item mb-0">
                                                <img alt="image" src="<?= BASEURL; ?>/public/img/avatar/avatar-2.png" class="img-fluid" data-toggle="tooltip" title="Ryan">
                                                <div class="avatar-badge" title="Admin" data-toggle="tooltip"><i class="fas fa-cog"></i></div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="summary">
                                        ...
                                        <div class="summary-item">
                                            ...
                                            <ul class="list-unstyled list-unstyled-border">
                                                <li class="media">
                                                    <a href="#">
                                                        <img class="mr-3 rounded" width="50" src="<?= BASEURL; ?>/public/img/products/product-1-50.png" alt="product">
                                                    </a>
                                                    <div class="media-body">
                                                ...
                                                <li class="media">
                                                    <a href="#">
                                                        <img class="mr-3 rounded" width="50" src="<?= BASEURL; ?>/public/img/products/product-2-50.png" alt="product">
                                                    </a>
                                                    <div class="media-body">
                                                ...
                                                <li class="media">
                                                    <a href="#">
                                                        <img class="mr-3 rounded" width="50" src="<?= BASEURL; ?>/public/img/products/product-3-50.png" alt="product">
                                                    </a>
                                                    <div class="media-body">
                                ...
                                <div class="card-body">
                                    <ul class="list-unstyled list-unstyled-border">
                                        ...
                                        <li class="media">
                                            ...
                                            <img class="mr-3 rounded-circle" width="50" src="<?= BASEURL; ?>/public/img/avatar/avatar-5.png" alt="avatar">
                                            <div class="media-body">
                                        ...
                                        <table class="table table-striped mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#" class="font-weight-600"><img src="<?= BASEURL; ?>/public/img/avatar/avatar-1.png" alt="avatar" width="30" class="rounded-circle mr-1"> Bagus Dwi Cahya</a>
                                                    </td>
                                                    <td>
    ...
    <!-- General JS Scripts -->
    <script src="<?= BASEURL; ?>/public/modules/jquery.min.js"></script>
    <script src="<?= BASEURL; ?>/public/modules/popper.js"></script>
    <script src="<?= BASEURL; ?>/public/modules/tooltip.js"></script>
    <script src="<?= BASEURL; ?>/public/modules/bootstrap/js/bootstrap.min.js"></script>
    <script src="<?= BASEURL; ?>/public/modules/nicescroll/jquery.nicescroll.min.js"></script>
    <script src="<?= BASEURL; ?>/public/modules/moment.min.js"></script>
    <script src="<?= BASEURL; ?>/public/js/stisla.js"></script>

    <!-- JS Libraies -->
    <script src="<?= BASEURL; ?>/public/modules/simple-weather/jquery.simpleWeather.min.js"></script>
    <script src="<?= BASEURL; ?>/public/modules/chart.min.js"></script>
    <script src="<?= BASEURL; ?>/public/modules/jqvmap/dist/jquery.vmap.min.js"></script>
    <script src="<?= BASEURL; ?>/public/modules/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script src="<?= BASEURL; ?>/public/modules/summernote/summernote-bs4.js"></script>
    <script src="<?= BASEURL; ?>/public/modules/chocolat/dist/js/jquery.chocolat.min.js"></script>

    <!-- Page Specific JS File -->
    <script src="<?= BASEURL; ?>/public/js/page/index-0.js"></script>
